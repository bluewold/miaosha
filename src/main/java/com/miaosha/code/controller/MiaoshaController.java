...
import com.miaosha.code.access.AccessLimit;
...
import com.miaosha.code.rabbitmq.MiaoshaMessage;
import com.miaosha.code.redis.GoodsKey;
import com.miaosha.code.redis.MiaoshaKey;
...
import com.miaosha.code.service.MiaoshaService;
...
@Controller
@Api(value = "/miaosha",description="这是秒杀接口")
...
public class MiaoshaController implements InitializingBean {
	...
	@ApiOperation(value="重置接口",httpMethod = "GET")
    @ResponseBody
	...
	@ApiOperation(value="秒杀接口",httpMethod = "POST")
	@ResponseBody
	public Result<Integer> miaoshadirect(Model model, MiaoshaUser user,
	...
	@ApiOperation(value="随机地址秒杀接口",httpMethod = "GET")
	@ResponseBody
	...
	@ApiOperation(value="获取秒杀结果接口",httpMethod = "GET")
    @ResponseBody
	...
	@ApiOperation(value="获取随机秒杀地址的接口",httpMethod = "GET")
    @ResponseBody
